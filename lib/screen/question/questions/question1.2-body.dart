...
import 'package:knowitall/screen/question/questions/question1.3-body.dart';
import 'package:knowitall/screen/question/widget/questions-widget.dart';
import 'package:knowitall/screen/screen.dart';
// import 'package:mongo_dart/mongo_dart.dart';

class QuestionBody1_2 extends StatelessWidget {
  const QuestionBody1_2({Key? key}) : super(key: key);
              ...
              Column(
                children: [
                  Container(
                    ...
                    child: Text(
                      "Это государство расположено на островах самого большого архипелага на Земле. Страна славится густыми лесами с гигантскими деревьями и разновидностью бамбука, который достигает ежедневного прироста в четверть метра.",
                      style: GoogleFonts.nunito(
                ...
                child: Expanded(
                  child: Container(
                    ...
                    child: QuestionList(
                      ...
                      answers: const [false, true, false, false],
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => QuestionBody1_3()));
              },
