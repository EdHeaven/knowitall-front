...
import 'package:knowitall/screen/question/questions/question1.2-body.dart';
import 'package:knowitall/screen/question/widget/questions-widget.dart';
import 'package:knowitall/screen/screen.dart';
// import 'package:mongo_dart/mongo_dart.dart';

class QuestionBody1_1 extends StatelessWidget {
  const QuestionBody1_1({Key? key}) : super(key: key);
              ...
              Column(
                children: [
                  Container(
                    ...
                    child: Text(
                      "Страна, протянувшаяся вдоль побережья Тихого океана, климат которой меняется от умеренного морского на юге до тропических пустынь на севере; эта страна производит и экспортирует медь.",
                      style: GoogleFonts.nunito(
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => QuestionBody1_2()));
              },
