...
import 'package:knowitall/screen/question/questions/question1.5-body.dart';
import 'package:knowitall/screen/question/widget/questions-widget.dart';
import 'package:knowitall/screen/screen.dart';
// import 'package:mongo_dart/mongo_dart.dart';

class QuestionBody1_4 extends StatelessWidget {
  const QuestionBody1_4 ({Key? key}) : super(key: key);
              ...
              Column(
                children: [
                  Container(
                    ...
                    child: Text(
                      "Островное государство в Европе, которое славится своей уникальной природой. В этой стране расположена знаменитая Долина гейзеров. Тут есть фьорды, прекрасные водопады, ледники и вулканы.",
                      style: GoogleFonts.nunito(
                ...
                child: Expanded(
                  child: Container(
                    ...
                    child: QuestionList(
                      ...
                      answers: const [false, false, false, true],
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => QuestionBody1_5()));
              },
