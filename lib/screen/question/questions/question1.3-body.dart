...
import 'package:knowitall/screen/question/questions/question1.4-body.dart';
import 'package:knowitall/screen/question/widget/questions-widget.dart';
import 'package:knowitall/screen/screen.dart';
// import 'package:mongo_dart/mongo_dart.dart';

class QuestionBody1_3 extends StatelessWidget {
  const QuestionBody1_3({Key? key}) : super(key: key);
              ...
              Column(
                children: [
                  Container(
                    ...
                    child: Text(
                      "Высокоразвитая индустриальная страна в Западной Европе. Здесь самая высокая в мире выплавка стали на душу населения. Несмотря на небольшой размер, является крупным банковским центром для иностранного капитала.",
                      style: GoogleFonts.nunito(
                ...
                child: Expanded(
                  child: Container(
                    ...
                    child: QuestionList(
                      ...
                      answers: const [true, false, false, false],
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => QuestionBody1_4()));
              },
